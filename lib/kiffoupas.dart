...
void main() {
  ...
  runApp(new KiffOuPas());
}

class KiffOuPas extends StatelessWidget {
...
class _MyReviewPageState extends State<MyReviewPage>
  ...
  void initState() {
    ...
    badArcItem = ArcItem("Pas du tout!", [Color(0xFFfe0944), Color(0xFFfeae96)], 0.0);
    ughArcItem = ArcItem("J'sais pas", [Color(0xFFF9D976), Color(0xfff39f86)], 0.0);
    okArcItem = ArcItem("C'était sympa", [Color(0xFF21e1fa), Color(0xff3bb8fd)], 0.0);
    goodArcItem = ArcItem("Grave", [Color(0xFF3ee98a), Color(0xFF41f7c7)], 0.0);
  ...
  Widget build(BuildContext context) {
    var textStyle = new TextStyle(
        color: Colors.white, fontSize: 18.00, fontWeight: FontWeight.bold);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Center(
            child: Padding(
              padding: const EdgeInsets.all(10.0),  /* Le text ici */
              child: Text(
                "Hey ... La Poste, tu as kiffé ?",
...
class SmilePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    if (size != lastSize) {
      ...
      //get max width of text, that is width of 'SUPER' text
...
class ChooserState extends State<ArcChooser>
  ...
  void initState() {
    ...
    arcItems.add(ArcItem("J'sais pas!", [Color(0xFFF9D976), Color(0xfff39f86)],
        angleInRadiansByTwo + userAngle));
    arcItems.add(ArcItem("C'était sympa", [Color(0xFF21e1fa), Color(0xff3bb8fd)],
        angleInRadiansByTwo + userAngle + (angleInRadians)));
    arcItems.add(ArcItem("J'avoue", [Color(0xFF3ee98a), Color(0xFF41f7c7)],
        angleInRadiansByTwo + userAngle + (2 * angleInRadians)));
    arcItems.add(ArcItem("Pas du tout!", [Color(0xFFfe0944), Color(0xFFfeae96)],
...
class ChooserPainter extends CustomPainter {
  ...
  final linePaint = new Paint()
    ..color = Colors.black.withAlpha(20) //0xFFF9D976
    ..strokeWidth = 2.0
    ..style = PaintingStyle.stroke
  ...
  void paint(Canvas canvas, Size size) {
    //common calc
    double centerX = size.width / 2;      // Règler la position de l'arc
    double centerY = size.height * 1.6;   // Règler la position de l'arc
