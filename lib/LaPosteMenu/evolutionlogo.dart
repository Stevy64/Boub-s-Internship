...
void main() {
  runApp(EvolutionLogo());
}

class EvolutionLogo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Evolution des logos',
...
final String presentationText = "La couleur historique de la Poste est le jaune depuis les années​ ​1960​. Auparavant les boîtes "
    "aux lettres étaient bleues et les véhicules verts.\n"
    "Le jaune pour symboliser la lumière et la vitesse.\n\n"
    "Le logotype de la Poste remonte lui aussi aux années​ ​ 1960​ et n'a que peu évolué depuis. Il a été créé par "
    "Guy Georget et représente un oiseau stylisé. Il est surnommé l'oiseau postal (l'hirondelle) pour sa vitesse.";

final String logo78Text = "C'est le décolage .";

final String logo84Text = "Première version du logo actuel";

final String logo05Text = "Troisième version du logo actuel";

final String logo12Text = "Quatrième version du logo actuel";

final String logo18Text = "Cinquième version du logo actuel";

final String logoActuelText = "Sixième version du logo actuel, depuis 2018.";


final sampleItems = <IntroItem>[
  new IntroItem(title: presentationText, category: "LOGOTYPE", imageUrl: 'assets/LaPosteImages/POSTE/GroupeLaPoste/laposte.jpg',),
  new IntroItem(title: logo78Text, category: "LOGO 1960 à 1978", imageUrl: 'assets/LaPosteImages/POSTE/GroupeLaPoste/logo1.png',),
  new IntroItem(title: logo84Text, category: "LOGO 1978 à 1984", imageUrl: 'assets/LaPosteImages/POSTE/GroupeLaPoste/logo2.png',),
  new IntroItem(title: logo05Text, category: "LOGO 1995 à 2005", imageUrl: 'assets/LaPosteImages/POSTE/GroupeLaPoste/logo3.png',),
  new IntroItem(title: logo12Text, category: "LOGO 2005 à 2012", imageUrl: 'assets/LaPosteImages/POSTE/GroupeLaPoste/logo4.png',),
  new IntroItem(title: logo18Text, category: "LOGO 2012 à 2018", imageUrl: 'assets/LaPosteImages/POSTE/GroupeLaPoste/logo5.png',),
  new IntroItem(title: logoActuelText, category: "LOGO ACTUEL", imageUrl: 'assets/LaPosteImages/POSTE/GroupeLaPoste/logo6.png',),
];
