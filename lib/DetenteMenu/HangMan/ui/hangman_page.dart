...
const List<String> progressImages = const [
  'assets/hang_images/img/progress_0.png',
  'assets/hang_images/img/progress_1.png',
  'assets/hang_images/img/progress_2.png',
  'assets/hang_images/img/progress_3.png',
  'assets/hang_images/img/progress_4.png',
  'assets/hang_images/img/progress_5.png',
  'assets/hang_images/img/progress_6.png',
  'assets/hang_images/img/progress_7.png',
];

const String victoryImage = 'assets/hang_images/img/victory.png';
...
class _HangmanPageState extends State<HangmanPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Le Pendu Postal'),
      ),
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/LaPosteImages/POSTE/PicSaintPriest/lependu1.jpg'),
              fit: BoxFit.cover,
            )),
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              // Image
              Expanded(
                child: Image.asset(_activeImage, scale: 15.0,),
              ),
              // Word
              Padding(
